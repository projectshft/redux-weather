...
import { fetchForecast, setDefaultCity, fetchWithCords } from "../actions/index";
...
const SearchBar = () => {
  ...
  const geoSuccess = function(position) {
    ...
    const url = `https://api.openweathermap.org/geo/1.0/reverse?lat=${latitude}&lon=${longitude}&appid=d8962aecd5213db8fadda59d04d64a81`;
  ...
  // add loading and disable buttons or opposite of that
