  ...
  <div className="container">
    ...
    <div className="row">
      <div className="col-md-6 offset-md-3">
        <input type="text" className="form-control" id="city-input" placeholder="Get a five-day forecast for your favorite cities" onChange={changeHandler} value={inputValue}></input>
      </div>
      <div className="col">
      ...
      <table className="table">
        <thead className="table-light text-center">
          <tr>
            ...
            <th scope="col" className="temp-header">Temperature ({'\xB0F'})</th>
